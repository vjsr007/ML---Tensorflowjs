...
const createModel = () => {
    ...
    //categoricalCrossentropy got a loss: 0.00047714009997434914 with softmax activation
    //binaryCrossentropy got a loss: 0.005247491877526045 with softmax activation
    model.compile({ optimizer: optimizer, loss: 'categoricalCrossentropy', lr: learningRate });
}
